...
public class Log_In_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // if driver
                if (User_type == "D"){
                    readDriver(Username, Password);
                    }

                // if passenger
                if (User_type == "P"){
                    readPassenger(Username, Password);
                }
    ...
    public void readPassenger(String Username, String Password){
    ...
    public void readDriver(String Username, String Password){
